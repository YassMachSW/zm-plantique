...
function App() {
  ...
  <div style={{ display: 'flex', gap: '20px', marginTop: '10px' }}>
    {/* אינסטגרם */}
    <a href="instagram://user?username=deligh_tech" target="_blank" rel="noreferrer" style={{ color: '#2e4a33', fontSize: '24px' }}>
      <i className="fab fa-instagram"></i>
    </a>

    {/* טלפון */}
    <a href="tel:0545317545" style={{ color: '#2e4a33', fontSize: '24px' }}>
